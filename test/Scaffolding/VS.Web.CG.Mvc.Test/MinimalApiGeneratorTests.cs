...
namespace Microsoft.VisualStudio.Web.CodeGenerators.Mvc
{
    public class MinimalApiGeneratorTests
    {
        ...
        public void GetTemplateNameTests()
        {
            ...
            Assert.Equal(Constants.MinimalApiEfNoClassTemplate + Constants.RazorTemplateExtension, MinimalApiGenerator.GetTemplateName(modelWithContext, existingEndpointsFile: true));
            Assert.Equal(Constants.MinimalApiEfTemplate + Constants.RazorTemplateExtension, MinimalApiGenerator.GetTemplateName(modelWithContext, existingEndpointsFile: false));
            Assert.Equal(Constants.MinimalApiNoClassTemplate + Constants.RazorTemplateExtension, MinimalApiGenerator.GetTemplateName(modelWithoutContext, existingEndpointsFile: true));
            Assert.Equal(Constants.MinimalApiTemplate + Constants.RazorTemplateExtension, MinimalApiGenerator.GetTemplateName(modelWithoutContext, existingEndpointsFile: false));
        }
